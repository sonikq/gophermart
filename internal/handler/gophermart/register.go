...
func (h *Handler) Register(ctx *gin.Context) {
	...
	if err = h.service.Register(c, request); err != nil {
		if errors.Is(err, models.ErrLoginIsAlreadyTaken) {
	...
	ctx.JSON(http.StatusOK, gin.H{"message": "The user is successfully registered and authenticated"})
}
