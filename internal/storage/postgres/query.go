...
const (
	...
	updateBalanceQuery  = `INSERT INTO balances(order_num, username, current_balance) VALUES ($1, $2, $3) ON CONFLICT (username) DO UPDATE SET current_balance = balances.current_balance + $3, order_num = $1;`
